...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://floating-earth-61602.herokuapp.com',
...
var locApi = __webpack_require__(17);
var locUi = __webpack_require__(6);
...
var validateLatLong = function validateLatLong(data) {
  return new Promise(function (resolve, reject) {
    ...
    if (!$.isNumeric(lat)) {
      var error = 'Latitude value is not valid';
      reject(error);
    } else if (!$.isNumeric(long)) {
      var _error = 'Longitude value is not valid';
      reject(_error);
    }
    ...
    if (parseInt(lat) > 90 || parseInt(lat) < -90) {
      var _error2 = 'Latitude value is not valid (90)';
      reject(_error2);
    } else if (parseInt(long) > 180 || parseInt(long) < -180) {
      var _error3 = 'Longitude value is not valid (180)';
      reject(_error3);
    }
...
var onGetLocations = function onGetLocations() {
  // api
  locApi.getLocations().then(locUi.getAllSuccess).catch(locUi.getAllError);
};

var onCreateLocation = function onCreateLocation() {
  ...
  // }
  validateLatLong(data).then(locApi.createLocation).then(locUi.createSuccess).then(onGetLocations).catch(locUi.createError);
};

var onConfirmDeleteLocation = function onConfirmDeleteLocation() {
  var locationID = parseInt(event.target.parentElement.parentElement.getAttribute('data-id'));
  // console.log('locationID is ', locationID)
  store.delete = locationID;
  var locationToDelete = store.locations.find(function (x) {
...
var onDeleteLocation = function onDeleteLocation() {
  // api
  locApi.deleteLocation(store.delete).then(locUi.deleteSuccess).catch(locUi.deleteError).then(onGetLocations);
};

var onConfirmUpdateLocation = function onConfirmUpdateLocation() {
  var locationID = parseInt(event.target.parentElement.parentElement.getAttribute('data-id'));
  var locationToUpdate = store.locations.find(function (x) {
    return x.id === locationID;
  });
  locUi.populateUpdateModal(locationToUpdate);
};

var onUpdateLocation = function onUpdateLocation() {
  event.preventDefault();
  var data = getFormFields(event.target.parentElement);
  // if (!('default' in data.location)) {
  //   data.location.default = false
  // } else {
  //   data.location.default = true
  // }
  validateLatLong(data).then(locApi.updateLocation).then(locUi.updateSuccess).then(onGetLocations).catch(locUi.updateError);
};

module.exports = {
  onGetLocations: onGetLocations,
  onCreateLocation: onCreateLocation,
  onConfirmDeleteLocation: onConfirmDeleteLocation,
  onDeleteLocation: onDeleteLocation,
  onConfirmUpdateLocation: onConfirmUpdateLocation,
...
var store = __webpack_require__(1);
var locationsTemplate = __webpack_require__(18);
...
var clearUpdateModal = function clearUpdateModal() {
...
// fadeTime: 3000
var createAlert = function createAlert(location, context, msgBold, msgText, fadeTime) {
...
var createLocationTable = function createLocationTable(data) {
  // console.log('createLocationTable data is ', data)
  // generate a table row for each file using handlebars
  var locationsHtml = locationsTemplate({ locations: data.locations });
...
var getAllError = function getAllError() {
...
module.exports = {
  ...
  populateUpdateModal: populateUpdateModal,
...
var addNestedValue = __webpack_require__(36);
...
// GET BOSTON FORECAST
var getBostonForecast = function getBostonForecast() {
  return $.ajax({
    method: 'GET',
...
var getLocationForecast = function getLocationForecast(data) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/forecasts',
    data: data
...
module.exports = {
  getBostonForecast: getBostonForecast,
...
var checkPrecipProbability = function checkPrecipProbability(data) {
...
var getBostonSuccess = function getBostonSuccess(response) {
  clearForms();
  resetAnswer();
  $('.answer-location').html('In Boston');
  var prob = (response.daily.data[0].precipProbability * 100).toFixed(0) + '%';
  $('.answer-stat').html('Precipitation probability is ' + prob);
  // console.log('getBostonSuccess response is ', response)
  var weekArray = response.daily.data;
...
var getBostonError = function getBostonError() {
  clearForms();
...
var getForecastSuccess = function getForecastSuccess(response) {
  resetAnswer();
  clearForms();
...
var getForecastError = function getForecastError(error) {
  clearForms();
...
module.exports = {
  getBostonSuccess: getBostonSuccess,
  getBostonError: getBostonError,
  getForecastSuccess: getForecastSuccess,
  getForecastError: getForecastError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var locEvents = __webpack_require__(5);
var fEvents = __webpack_require__(37);
var coorEvents = __webpack_require__(38);
var coorRegions = __webpack_require__(41);
...
var updateLocation = function updateLocation(data) {
  var id = store.update.location.id;
  return $.ajax({
    method: 'PATCH',
    url: config.apiUrl + '/locations/' + id,
    headers: {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <tr class=\"location-row\" data-id=\""
    ...
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.lat : stack1), depth0))
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1["long"] : stack1), depth0))
    + "</td>\n      <td><button type=\"button\" class=\"btn-line clickable check-weather-btn\">Check weather</button></td>\n      <td><button type=\"button\" class=\"btn-line clickable update-btn\" data-toggle=\"modal\" data-target=\"#updateModal\">Edit</span></button></td>\n      <td><button type=\"button\" class=\"btn-line clickable delete-btn\" data-toggle=\"modal\" data-target=\"#deleteModal\">Delete</span></button></td>\n  </tr>\n";
...
var fApi = __webpack_require__(10);
var fUi = __webpack_require__(11);
var locEvents = __webpack_require__(5);
var store = __webpack_require__(1);
var getFormFields = __webpack_require__(7);

var onGetBostonForecast = function onGetBostonForecast() {
  // api
  fApi.getBostonForecast().then(fUi.getBostonSuccess).catch(fUi.getBostonError);
};

var onGetLocationForecast = function onGetLocationForecast(event) {
  // console.log('onGetLocationForecast ran')
  var locationID = parseInt(event.target.parentElement.parentElement.getAttribute('data-id'));
  // console.log('locationID is ', locationID)
  var data = {};
  data.location = store.locations.find(function (x) {
    return x.id === locationID;
  });
  store.query = store.locations.find(function (x) {
    return x.id === locationID;
  });
  // console.log('store.query is ', store.query)
  // console.log('onGetLocationForecast data is ', data)
  // api
  fApi.getLocationForecast(data).then(fUi.getForecastSuccess).catch(fUi.getForecastError);
};

var onFindByLatLong = function onFindByLatLong() {
  ...
  .then(function () {
    ...
    return data;
  }).then(fApi.getLocationForecast).then(fUi.getForecastSuccess).catch(fUi.getForecastError);
};

module.exports = {
  onGetBostonForecast: onGetBostonForecast,
  onGetLocationForecast: onGetLocationForecast,
  onFindByLatLong: onFindByLatLong
};
...
var coorApi = __webpack_require__(39);
var coorUi = __webpack_require__(40);
var fApi = __webpack_require__(10);
var fUi = __webpack_require__(11);
var locEvents = __webpack_require__(5);
var store = __webpack_require__(1);
...
var checkCoordinates = function checkCoordinates(response) {
  return new Promise(function (resolve, reject) {
    // console.log('checkIfObjObj response is ', response)
    // debugger
    if (response.location.lat === '0.00000') {
      var error = 'Invalid search value. Please try again. (coor)';
      reject(error);
    } else if (response.location.long === '0.00000') {
      var _error = 'Invalid search value. Please try again. (coor)';
      reject(_error);
    }
    resolve(response);
  });
...
var onFindByName = function onFindByName(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  ...
  var regex = /\d/g;
  if (regex.test(name)) {
    var error = 'Invalid search value. Please try again. (num)';
    coorUi.getCoordinatesError(error);
    return;
    // check if name is too long
  } else if (name.length > 40) {
    var _error2 = 'Search value is too long. Please try again.';
    coorUi.getCoordinatesError(_error2);
    return;
  }
  // check if name has symbols
  var invalidSymbols = new RegExp(/[~`()!#$%^&*+=[\]\\';/{}|\\":<>?]/);
  if (invalidSymbols.test(name)) {
    var _error3 = 'Invalid search value. Please try again. (symb)';
    coorUi.getCoordinatesError(_error3);
    return;
  }
  data.query.region = data.query.country;
  console.log('data in onFindByName is ', data);
  // api
  coorApi.getCoordinatesByName(data).then(coorUi.getCoordinatesSuccess).then(checkCoordinates)
  // .then((data) => { console.log('data in .then is ', data) })
  .then(fApi.getLocationForecast).then(fUi.getForecastSuccess).catch(coorUi.getCoordinatesError);
};

var runGeolocation = function runGeolocation() {
  return new Promise(function (resolve, reject) {
    var data = { location: {}
      ...
      var error = 'Geolocation not available, please enter coordinates';
      reject(error);
    }
  });
};

var onFindUserPosition = function onFindUserPosition() {
  runGeolocation().then(function (data) {
    // console.log('data after runGeolocation is ', data)
    return data;
  }).then(locEvents.validateLatLong).then(function (data) {
...
module.exports = {
  onFindByName: onFindByName,
  onFindUserPosition: onFindUserPosition
};
...
var getCoordinatesByName = function getCoordinatesByName(data) {
  return $.ajax({
    method: 'GET',
...
var getCoordinatesSuccess = function getCoordinatesSuccess(response) {
...
var getCoordinatesError = function getCoordinatesError(error) {
  locUi.clearForms();
...
module.exports = {
  getCoordinatesSuccess: getCoordinatesSuccess,
  getCoordinatesError: getCoordinatesError
};
...
var regionNorthAmerica = [{ text: 'United States', value: 'US' }, { text: 'Canada', value: 'CA' }, { text: 'Mexico', value: 'MX' }];

var regionEurope = [{ text: 'Albania', value: 'AL' }, { text: 'Andorra', value: 'AD' }, { text: 'Armenia', value: 'AM' }, { text: 'Austria', value: 'AT' }, { text: 'Azerbaijan', value: 'AZ' }, { text: 'Belgium', value: 'BE' }, { text: 'Belarus', value: 'BY' }, { text: 'Bosnia', value: 'BA' }, { text: 'Croatia', value: 'HR' }, { text: 'Cyprus', value: 'CY' }, { text: 'Czech Republic', value: 'CZ' }, { text: 'Denmark', value: 'DK' }, { text: 'Estonia', value: 'EE' }, { text: 'Faroe Islands', value: 'FO' }, { text: 'Finland', value: 'FI' }, { text: 'France', value: 'FR' }, { text: 'Georgia', value: 'GE' }, { text: 'Germany', value: 'DE' }, { text: 'Greece', value: 'GR' }, { text: 'Hungary', value: 'HU' }, { text: 'Iceland', value: 'IS' }, { text: 'Ireland', value: 'IE' }, { text: 'Italy', value: 'IT' }, { text: 'Latvia', value: 'LV' }, { text: 'Liechtenstein', value: 'LI' }, { text: 'Lithuania', value: 'LT' }, { text: 'Luxembourg', value: 'LU' }, { text: 'Macedonia', value: 'MK' }, { text: 'Monaco', value: 'MC' }, { text: 'Moldova', value: 'MD' }, { text: 'Montenegro', value: 'ME' }, { text: 'Malta', value: 'MT' }, { text: 'Netherlands', value: 'NL' }, { text: 'Norway', value: 'NO' }, { text: 'Poland', value: 'PL' }, { text: 'Portugal', value: 'PT' }, { text: 'Romania', value: 'RO' }, { text: 'Russia', value: 'RU' }, { text: 'Serbia', value: 'RS' }, { text: 'Slovakia', value: 'SK' }, { text: 'Slovenia', value: 'SI' }, { text: 'Spain', value: 'ES' }, { text: 'Sweden', value: 'SE' }, { text: 'Switzerland', value: 'CH' }, { text: 'Turkey', value: 'TR' }, { text: 'Ukraine', value: 'UA' }, { text: 'United Kingdom', value: 'UK' }];

var regionAsia = [{ text: 'Afghanistan', value: 'AF' }, { text: 'Azerbaijan', value: 'AZ' }, { text: 'Bahrain', value: 'BH' }, { text: 'Bangladesh', value: 'BD' }, { text: 'Bhutan', value: 'BT' }, { text: 'Brunei', value: 'BN' }, { text: 'Cambodia', value: 'KH' }, { text: 'China', value: 'CN' }, { text: 'Georgia', value: 'GE' }, { text: 'Hong Kong', value: 'HK' }, { text: 'India', value: 'IN' }, { text: 'Indonesia', value: 'ID' }, { text: 'Israel', value: 'IL' }, { text: 'Iran', value: 'IR' }, { text: 'Iraq', value: 'IQ' }, { text: 'Israel', value: 'IL' }, { text: 'Japan', value: 'JP' }, { text: 'Jordan', value: 'JO' }, { text: 'Kazakhstan', value: 'KZ' }, { text: 'Korea', value: 'KR' }, { text: 'Kuwait', value: 'KW' }, { text: 'Kyrgyzstan', value: 'KG' }, { text: 'Laos', value: 'LA' }, { text: 'Lebanon', value: 'LB' }, { text: 'Macau', value: 'MO' }, { text: 'Malaysia', value: 'MY' }, { text: 'Maldives', value: 'MV' }, { text: 'Mongolia', value: 'MN' }, { text: 'Myanmar', value: 'MM' }, { text: 'Nepal', value: 'NP' }, { text: 'Oman', value: 'OM' }, { text: 'Philippines', value: 'PH' }, { text: 'Palestine', value: 'PS' }, { text: 'Qatar', value: 'QA' }, { text: 'Saudi Arabia', value: 'SA' }, { text: 'Singapore', value: 'SG' }, { text: 'Sri Lanka', value: 'LK' }, { text: 'Syria', value: 'SY' }, { text: 'Taiwan', value: 'TW' }, { text: 'Tajikistan', value: 'TJ' }, { text: 'Thailand', value: 'TH' }, { text: 'Turkey', value: 'TR' }, { text: 'Turkmenistan', value: 'TM' }, { text: 'United Arab Emirates', value: 'AE' }, { text: 'Uzbekistan', value: 'UZ' }, { text: 'Vietnam', value: 'VN' }, { text: 'Yemen', value: 'YE' }];

var regionOceania = [{ text: 'American Samoa', value: 'AS' }, { text: 'Australia', value: 'AU' }, { text: 'Cook Islands', value: 'CK' }, { text: 'East Timor', value: 'TL' }, { text: 'Federated Staes of Micronesia', value: 'FM' }, { text: 'Fiji Islands', value: 'FJ' }, { text: 'French Polynesia', value: 'PF' }, { text: 'Guam', value: 'GU' }, { text: 'Kiribati', value: 'KI' }, { text: 'Marshall Islands', value: 'MH' }, { text: 'Nauru', value: 'NR' }, { text: 'New Caledonia', value: 'NC' }, { text: 'New Zealand', value: 'NZ' }, { text: 'Niue', value: 'NU' }, { text: 'Norfolk Island', value: 'NF' }, { text: 'Palau', value: 'PW' }, { text: 'Papua New Guinea', value: 'PG' }, { text: 'Saipan', value: 'MP' }, { text: 'Samoa', value: 'WS' }, { text: 'Solomon Islands', value: 'SB' }, { text: 'Tokelau', value: 'TK' }, { text: 'Tonga', value: 'TO' }, { text: 'Tuvalu', value: 'TV' }, { text: 'Wake Island', value: 'UM' }, { text: 'Vanuatu', value: 'VU' }, { text: 'Wallis and Futuna Islands', value: 'WF' }];

var regionSouthAmerica = [{ text: 'Argentina', value: 'AR' }, { text: 'Bolivia', value: 'BO' }, { text: 'Brazil', value: 'BR' }, { text: 'Chile', value: 'CL' }, { text: 'Colombia', value: 'CO' }, { text: 'Ecuador', value: 'EC' }, { text: 'French Guiana', value: '' }, { text: 'Guyana', value: 'GY' }, { text: 'Paraguay', value: 'PY' }, { text: 'Peru', value: 'PE' }, { text: 'Suriname', value: 'SR' }, { text: 'Uruguay', value: 'UY' }, { text: 'Venezuela', value: 'VE' }];

var regionCentralAmerica = [{ text: 'Belize', value: 'AR' }, { text: 'Costa Rica', value: 'BO' }, { text: 'El Salvador', value: 'BR' }, { text: 'Guatemala', value: 'CL' }, { text: 'Honduras', value: 'CO' }, { text: 'Mexico', value: 'EC' }, { text: 'Nicaragua', value: 'GY' }, { text: 'Panama', value: 'PY' }];

var regionCaribbean = [{ text: 'Anguilla', value: 'AI' }, { text: 'Antigua and Barbuda', value: 'AG' }, { text: 'Aruba', value: 'AW' }, { text: 'Bahamas', value: 'BS' }, { text: 'Barbados', value: 'BB' }, { text: 'Bonaire, Saint Eustatius and Saba', value: 'BQ' }, { text: 'British Virgin Islands', value: 'VG' }, { text: 'Cayman Islands', value: 'KY' }, { text: 'Cuba', value: 'CU' }, { text: 'Curaçao', value: 'CW' }, { text: 'Dominica', value: 'DM' }, { text: 'Dominican Republic', value: 'DO' }, { text: 'Grenada', value: 'GD' }, { text: 'Guadeloupe', value: 'GP' }, { text: 'Haiti', value: 'HT' }, { text: 'Jamaica', value: 'JM' }, { text: 'Martinique', value: 'MQ' }, { text: 'Monserrat', value: 'MS' }, { text: 'Puerto Rico', value: 'PR' }, { text: 'Saint-Barthélemy', value: 'BL' }, { text: 'Saint Kitts and Nevis', value: 'KN' }, { text: 'Saint Lucia', value: 'LC' }, { text: 'Saint Martin', value: 'MF' }, { text: 'Saint Vincent and the Grenadines', value: 'VC' }, { text: 'Trinidad and Tobago', value: 'TT' }, { text: 'Turks and Caicos Islands', value: 'TC' }, { text: 'Virgin Islands', value: 'VI' }];

var regionAfrica = [{ text: 'Algeria', value: 'DZ' }, { text: 'Angola', value: 'AO' }, { text: 'Benin', value: 'BJ' }, { text: 'Botswana', value: 'BW' }, { text: 'Burkina Faso', value: 'BF' }, { text: 'Burundi', value: 'BI' }, { text: 'Cameroon', value: 'CM' }, { text: 'Cape Verde', value: 'CV' }, { text: 'Central African Republic', value: 'CF' }, { text: 'Chad', value: 'TD' }, { text: 'Comoros', value: 'KM' }, { text: 'Congo', value: 'CG' }, { text: 'Ivory Coast', value: 'CI' }, { text: 'Djibouti', value: 'DJ' }, { text: 'Egypt', value: 'EG' }, { text: 'Equatorial Guinea', value: 'GQ' }, { text: 'Eritrea', value: 'ER' }, { text: 'Ethiopia', value: 'ET' }, { text: 'Gabon', value: 'GA' }, { text: 'Gambia', value: 'GM' }, { text: 'Ghana', value: 'GH' }, { text: 'Guinea', value: 'GN' }, { text: 'Guinea Bissau', value: 'GW' }, { text: 'Kenya', value: 'KE' }, { text: 'Lesotho', value: 'LS' }, { text: 'Liberia', value: 'LR' }, { text: 'Libya', value: 'LY' }, { text: 'Madagascar', value: 'MG' }, { text: 'Malawi', value: 'MW' }, { text: 'Mali', value: 'ML' }, { text: 'Mauritania', value: 'MR' }, { text: 'Mauritius', value: 'MU' }, { text: 'Mayotte', value: 'YT' }, { text: 'Morocco', value: 'MA' }, { text: 'Mozambique', value: 'MZ' }, { text: 'Namibia', value: 'NA' }, { text: 'Niger', value: 'NE' }, { text: 'Nigeria', value: 'NG' }, { text: 'Reunion', value: 'RE' }, { text: 'Rwanda', value: 'RW' }, { text: 'Sahara', value: 'EH' }, { text: 'St. Helena', value: 'SH' }, { text: 'St. Tome & Principe', value: 'ST' }, { text: 'Senegal', value: 'SN' }, { text: 'Seychelles', value: 'SC' }, { text: 'Sierra Leona', value: 'SL' }, { text: 'Somalia', value: 'SO' }, { text: 'South Africa', value: 'ZA' }, { text: 'South Sudan', value: 'SS' }, { text: 'Sudan', value: 'SD' }, { text: 'Swaziland', value: 'SZ' }, { text: 'Tanzania', value: 'TZ' }, { text: 'Togo', value: 'TG' }, { text: 'Tunisia', value: 'TN' }, { text: 'Uganda', value: 'UG' }, { text: 'Zambia', value: 'ZM' }, { text: 'Zimbabwe', value: 'ZW' }];

var regionList = [];

var PopulateRegionList = function PopulateRegionList() {
  console.log('PopulateRegionList ran');
  var select = document.getElementById('query-country');
  var selectedRegion = $('#query-region').val();
...
module.exports = {
  PopulateRegionList: PopulateRegionList
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = __webpack_require__.p + "a0a9861a3982d95b500ec24c39986eed.png";

/***/ }),
/* 51 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "02a34e69f0ebed3e6f38906f6c7316bf.png";

/***/ }),
/* 52 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "32225a030b1d284492a703ebfebdcbf6.png";
